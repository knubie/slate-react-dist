...
var MemoizedText = React__default.memo(Text, (prev, next) => {
...
var Element = props => {
  ...
  if (slate.Editor.isVoid(editor, element)) {
    ...
    var [[_text]] = slate.Node.texts(element);
...
var MemoizedElement = React__default.memo(Element, (prev, next) => {
...
var Editable = props => {
  ...
  var onDOMSelectionChange = React.useCallback(throttle(() => {
...
var withReact = editor => {
  ...
  e.setFragmentData = data => {
    ...
    var [start, end] = slate.Range.edges(selection);
